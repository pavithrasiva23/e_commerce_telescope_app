...
import '../utils/constants_user.dart';
...
class _CheckoutPageState extends State<CheckoutPage> {
  ...
  void _saveOrder() async {
    if (addressController.text.isEmpty) {
      Utils.showMsg(context, 'Please provide your address');
      return;
    }
    if (postalCodeController.text.isEmpty) {
      Utils.showMsg(context, 'Please provide your zip code');
      return;
    }
    if (city == null) {
      Utils.showMsg(context, 'Please select your city');
      return;
    }
    ...
    //Apply 'userAddress' to 'appUser.userAddress'
    ...
    try {
      ...
      EasyLoading.dismiss();
      Utils.showMsg(context, 'Order Placed');
