...
import 'package:shop_a_to_z_user/customwidgets/main_drawer.dart';
...
import '../customwidgets/telescope_grid_view_item.dart';
...
class _ViewTelescopePageState extends State<ViewTelescopePage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Consumer<TelescopeProvider>(builder: (context, provider, child)=>
      GridView.builder(
