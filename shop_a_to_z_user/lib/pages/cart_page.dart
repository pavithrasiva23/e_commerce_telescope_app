            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return CartItemView(cartModel: cartItem, provider: provider);
                },
              ),
            ),
            Card(
              child: Padding(
                  ...
                  child: Row(
                    children: [
                      Expanded(
                          child: Text('SUB TOTAL: $currencySymbol${provider.getCartSubTotal()}',
                          style: Theme.of(context).textTheme.titleLarge,
                          )),
                      OutlinedButton(
                          onPressed: provider.totalItemsInCart == 0 ? null : (){context.goNamed(CheckoutPage.routeName);},
